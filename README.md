...
- Step 2 Enable Internet Information Services in (I.S.S)
- Step 3 Install Web Platform Installer  
- Step 4 Install MySQL and set up the username and password
- Step 5 Install C++ Redistributable
- Step 6 Configure permissions and install OS Ticket

<h2>Installation Steps</h2>

1.) The first thing you are going to want to do is create a virtual machine by going to https://portal.azure.com/. Setup your virtual machine with Windows 10 Pro, version 22H2. Note, you will want to create a virtual machine with atleast 4 vCPUs and 16 Gb of memory.
